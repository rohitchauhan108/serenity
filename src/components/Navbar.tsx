...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const [mobileServicesSubmenuOpen, setMobileServicesSubmenuOpen] =
    useState(false);
  const [mobileTreatmentSubmenuOpen, setMobileTreatmentSubmenuOpen] =
    useState(false);
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2">
          <div className="flex items-center gap-2 text-teal-100 text-center md:text-left">
            ...
            <span className="font-medium">
              Immediate Crisis?{" "}
              <strong className="text-amber-200">Call or Text 988</strong> for
          ...
          <div className="hidden md:flex items-center gap-1 xl:gap-2">
            ...
            >
              ...
              >
                <span>About Us</span>
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 group-hover:rotate-180 ${aboutDropdownOpen ? "rotate-180 text-teal-700" : ""}`}
                />
              </button>
                ...
                <div className="w-80 bg-white rounded-2xl shadow-2xl border border-slate-100 p-3">
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-bold text-slate-900 group-hover/item:text-teal-900 flex items-center gap-1">
                        ...
                        <span className="text-[10px] bg-teal-100 text-teal-800 px-1.5 py-0.5 rounded-full font-semibold">
                          Clinic
                        </span>
                      </div>
                      <p className="text-xs text-slate-500 mt-0.5 leading-snug">
                        Our mission, clinical facility, patient privacy
                        standards & holistic care values.
                      </p>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5 leading-snug">
                        Board-certified practitioner, academic background,
                        credentials & treatment philosophy.
                      </p>
                    </div>
                  </Link>
            ...
            >
              ...
              >
                <span>Services</span>
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 group-hover:rotate-180 ${servicesDropdownOpen ? "rotate-180" : ""}`}
                />
              </button>
                ...
                <div className="w-[580px] bg-white rounded-2xl shadow-2xl border border-slate-100 p-5 grid grid-cols-2 gap-3">
                  <div className="col-span-2 pb-2 mb-1 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-slate-500">
                      Visit Our Treatment for therapy modalities
                    </span>
                  </div>
            ...
            >
              <button
                type="button"
                className="px-3.5 py-2 rounded-xl text-sm font-semibold flex items-center gap-1.5 hover:text-teal-700 transition-all duration-200"
              >
                <span>Our Treatment</span>

                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 group-hover:rotate-180 ${
                    treatmentDropdownOpen ? "rotate-180 text-teal-700" : ""
                  }`}
                />
              </button>
              ...
              >
                <div className="w-[580px] bg-white rounded-2xl shadow-2xl border border-slate-100 p-5 grid grid-cols-2 gap-3">
                  <div className="col-span-2 pb-2 mb-1 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-slate-500">
                      Comprehensive therapy & care options
                    </span>
                  </div>
            ...
            <div className="px-4 pt-[max(env(safe-area-inset-top),12px)] pb-6 max-h-[100dvh] overflow-y-auto overscroll-contain">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="w-full">
                  <button
                    onClick={() =>
                      setMobileAboutSubmenuOpen(!mobileAboutSubmenuOpen)
                    }
                  ...
                  >
                    <span>About Us</span>
                    <ChevronDown
                      className={`w-4 h-4 text-slate-500 transition-transform duration-300 ${mobileAboutSubmenuOpen ? "rotate-180" : ""}`}
                    />
                  </button>

                  <div
                    className={`overflow-hidden transition-all duration-300 ease-out ${mobileAboutSubmenuOpen ? "max-h-[600px] opacity-100" : "max-h-0 opacity-0"}`}
                  >
                    <div className="ml-4 pl-3 border-l-2 border-teal-200 my-1 space-y-1">
                      ...
                      >
                        ...
                        <span className="block font-normal text-xs text-slate-500 mt-0.5">
                          Clinic overview, mission & facility
                        </span>
                      </Link>
                      <Link
                        href="/dr-barbara"
                      ...
                      >
                        ...
                        <span className="block font-normal text-xs text-slate-500 mt-0.5">
                          DNP, PMHNP-BC credentials & philosophy
                        </span>
                      </Link>
                    </div>
                  </div>
                ...
                <div className="w-full">
                  <button
                    onClick={() =>
                      setMobileServicesSubmenuOpen(!mobileServicesSubmenuOpen)
                    }
                    className="w-full px-4 py-3 rounded-xl text-left font-semibold text-sm text-slate-800 hover:bg-slate-50 active:bg-slate-100 flex items-center justify-between"
                  >
                    <span>Services</span>
                    <ChevronDown
                      className={`w-4 h-4 text-slate-500 transition-transform duration-300 ${mobileServicesSubmenuOpen ? "rotate-180" : ""}`}
                    />
                  </button>

                  <div
                    className={`overflow-hidden transition-all duration-300 ease-out ${mobileServicesSubmenuOpen ? "max-h-[5000px] opacity-100" : "max-h-0 opacity-0"}`}
                  >
                    <div className="ml-4 pl-3 border-l-2 border-teal-300 my-2 space-y-1.5">
                      ...
                      {CORE_SERVICES_DATA.map((srv) => (
                        ...
                        >
                          ...
                          <div className="font-normal text-xs text-slate-500 mt-1 line-clamp-2 leading-snug">
                            {srv.shortDesc}
                          </div>
                        </Link>
                      ))}
                ...
                <div className="w-full">
                  <button
                    onClick={() =>
                      setMobileTreatmentSubmenuOpen(!mobileTreatmentSubmenuOpen)
                    }
                    className="w-full px-4 py-3 rounded-xl text-left font-semibold text-sm text-slate-800 hover:bg-slate-50 active:bg-slate-100 flex items-center justify-between"
                  >
                    <span>Our Treatment</span>
                    <ChevronDown
                      className={`w-4 h-4 text-slate-500 transition-transform duration-300 ${mobileTreatmentSubmenuOpen ? "rotate-180" : ""}`}
                    />
                  </button>

                  <div
                    className={`overflow-hidden transition-all duration-300 ease-out ${mobileTreatmentSubmenuOpen ? "max-h-[8000px] opacity-100" : "max-h-0 opacity-0"}`}
                  >
                    <div className="ml-4 pl-3 border-l-2 border-teal-300 my-2 space-y-1.5">
                      <Link
                        href="/our-treatment"
